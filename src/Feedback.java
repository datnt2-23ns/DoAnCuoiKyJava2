...
//    private JTextArea ta_noiDung;
//    private JTextArea ta_feedbackList;
//    private Feedback_Admin adminInstance; // Thêm trường này để lưu instance của Feedback_Admin
//
//    /**
//     * Launch the application.
//     */
...
//    }
//
//    // Phương thức mở Feedback_Admin
//    private void openFeedbackAdmin() {
//        adminInstance = new Feedback_Admin();
//        adminInstance.setFeedbackInstance(this); // Sử dụng phương thức này để liên kết với Feedback_Admin
...
//        String noiDung = ta_noiDung.getText();
//
//        // Gửi phản hồi tới server và nhận lại từ server
//        new Thread(() -> {
//            String response = FeedbackClient.sendFeedback(maDocGia, tenDocGia, noiDung);
//
//            // Hiển thị phản hồi từ server trên ta_feedbackList
//            updateFeedbackList(maDocGia + ": " + noiDung);
//            if (adminInstance != null) {
//                adminInstance.receiveAdminFeedback("Admin: " + response);
//            }
//        }).start();
//
...
//    }
//
//    // Phương thức nhận phản hồi từ Admin
...
//    }
//
//    // Phương thức cập nhật feedbackList
//    public void updateFeedbackList(String feedback) {
//        EventQueue.invokeLater(() -> {
//            ta_feedbackList.append(feedback + "\n");
//        });
//    }
...
public class Feedback extends JFrame {
    ...
    private void openFeedbackAdmin() {
        adminInstance = new Feedback_Admin();
        adminInstance.setFeedbackInstance(this);
        adminInstance.setVisible(true);
    }
    ...
    private void sendFeedback() {
        ...
        new Thread(() -> {
            ...
            updateFeedbackList(maDocGia + ": " + noiDung);
            if (adminInstance != null) {
                adminInstance.receiveAdminFeedback(maDocGia + ": " + noiDung);
            }
        }).start();
